...
class AccountEditView extends PureComponent {
    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                <Button onClick={() => {this.props.history.goBack()}}>Edit</Button>
            </div>
        );
    }
...
export default withStyles(styles, {withTheme : true})(withRouter(AccountEditView));
